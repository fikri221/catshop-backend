            ...
            <div class="card-body card-block">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        ...
                        <small class="help-block form-text">Please enter the category of the
                            product</small>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="number" id="qty" name="qty" placeholder="Quantity" class="form-control"
                            value="{{ old('qty') }}" /><small class="help-block form-text">Please enter the
                            quantity</small>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="number" id="price" name="price" placeholder="Price" class="form-control"
                            value="{{ old('price') }}" /><small class="help-block form-text">Please enter the price in
                            IDR</small>
                    </div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="file" id="file-multiple-input" name="images" value="{{ old('images') }}"
